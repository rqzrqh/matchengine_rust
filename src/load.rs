        ...
        while i < count {
            ...
            let order = Rc::new(Order{
                ...
                price: {
                    ...
                    restore_decimal_or_panic(raw, m.price_prec(), "price", &table, order_id)
                },
                amount: {
            ...
            info!(
                "restore loaded order: table={} order_id={} type={} side={} create_time={} update_time={} user_id={} price={} amount={} taker_fee_rate={} maker_fee_rate={} left={} deal_stock={} deal_money={} deal_fee={}",
                table,
                order.id,
                order.order_type,
                order.side,
                ...
                order.price,
                order.amount.get(),
                order.taker_fee_rate,
                order.maker_fee_rate,
                order.left.get(),
                order.deal_stock.get(),
                order.deal_money.get(),
                order.deal_fee.get()
            );
